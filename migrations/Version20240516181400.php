 ...
 */
final class Version20240516181400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE convention (id INT AUTO_INCREMENT NOT NULL, code_p_id INT DEFAULT NULL, mat_id INT NOT NULL, date_debut DATE NOT NULL, UNIQUE INDEX UNIQ_8556657EE5900963 (code_p_id), INDEX IDX_8556657EDCA7C833 (mat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE projet (id INT AUTO_INCREMENT NOT NULL, libelle_p VARCHAR(255) NOT NULL, secteur_p VARCHAR(255) NOT NULL, cout_fixe DOUBLE PRECISION NOT NULL, cout_var VARCHAR(255) NOT NULL, duree_p INT NOT NULL, picture_url VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
